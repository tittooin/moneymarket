...
def write_article(item):
    ...
    lines.append('<h2>Opening</h2>')
    lines.append('<p>'+opening+'</p>')
    lines.append('<h2>Main Story</h2>')
    lines.append('<p>'+main+'</p>')
    lines.append('<h2>Context & Background</h2>')
    lines.append('<p>'+ctx+'</p>')
    lines.append('<h2>Market/Investor Impact</h2>')
    lines.append('<p>'+impact+'</p>')
    lines.append('<h2>Analysis</h2>')
    lines.append('<p>'+analysis+'</p>')
    lines.append('<h2>Simple Explanation</h2>')
    lines.append('<p>'+more+'</p>')
    lines.append('<h2>Conclusion</h2>')
    lines.append('<p>'+concl+'</p>')
    lines.append('<p>Source reference: '+source+' (news reference only)</p>')
